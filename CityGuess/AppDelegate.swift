...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    private let googleService: GoogleMapService = GoogleMapImplementation()
    private let apiKey: String = "AIzaSyCFMnI_LEm5Yxs17HiTX3epaY392gSklBk"
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // responsible for view presentation
